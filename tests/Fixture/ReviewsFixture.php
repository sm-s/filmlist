...
class ReviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'body' => ['type' => 'string', 'length' => 500, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'film_key' => ['type' => 'index', 'columns' => ['film_id'], 'length' => []],
            'user_key' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'reviews_ibfk_1' => ['type' => 'foreign', 'columns' => ['film_id'], 'references' => ['films', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'reviews_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'rating' => 1,
            'created_at' => '2017-03-26 12:15:55',
            'is_public' => 1
        ],
    ];
}
